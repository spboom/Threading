...
namespace HWW3
{
    ...
    class Queue
    {
        ...
        private Semaphore _canGet = new Semaphore(0, CONST.BUFLEN);
        private Semaphore _canAdd = new Semaphore(CONST.BUFLEN, CONST.BUFLEN);

        private Semaphore _thisLock = new Semaphore(1, 1);
